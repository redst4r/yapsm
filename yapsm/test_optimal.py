...
def example_graph():
    ...
    G.add_edge('trt_0','ctl_4', cost=1, cost_original=1)
    G.add_edge('trt_0','ctl_5', cost=1, cost_original=1)
    G.add_edge('trt_1','ctl_5', cost=1, cost_original=1)
    G.add_edge('trt_2','ctl_5', cost=1, cost_original=1)
    G.add_edge('trt_3','ctl_6', cost=1, cost_original=1)
    G.add_edge('trt_3','ctl_7', cost=1, cost_original=1)
...
def test_correctness():
    ...
    om.construct_flow_graph(n_max=4)
